const page = {
  ...
  annotation: {
    project: {
      ...
      completed: 'Completed',
      members: 'Members',
      membersTip: 'Project members can view this project',
      cameraConfig: 'Camera Config (Optional)',
      cameraUrl: 'ISAPI URL',
      ...
      form: {
        ...
        configRequired: 'At least one of classes, tags, or comment is required',
        members: 'Please select project members',
        cameraUrl: 'Please enter camera ISAPI URL',
        cameraUsername: 'Please enter camera username',
        cameraPassword: 'Please enter camera password'
      }
    },
    projectDetail: {
    ...
    image: {
      ...
      annotateStatus: 'Status',
      annotator: 'Annotator',
      annotateTime: 'Annotate Time',
      pending: 'Pending',
      annotated: 'Annotated',
      reviewed: 'Reviewed',
    ...
    collect: {
      ...
      cameraComingSoon: 'Camera capture is coming soon',
      cameraNotConfigured: 'Camera not configured for this project. Please configure it in project settings first.'
    },
    camera: {
      title: 'Camera Capture',
      backToCollect: 'Back to Collection',
      clickToConnect: 'Click the button below to test camera connectivity',
      connectTest: 'Connect Test',
      checking: 'Checking...',
      connected: 'Connected',
      disconnected: 'Disconnected',
      disconnect: 'Disconnect',
      connectFailed: 'Cannot connect to camera. Please check device status.',

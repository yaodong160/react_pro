import { useLoading } from '@chiko-admin/hooks';

import { globalConfig } from '@/config';
import { getIsLogin, selectUserInfo } from '@/stores/modules/auth';
import { usePreviousRoute, useRouter } from '@/features/router';
import { fetchGetUserInfo, fetchLogin } from '@/services/api';
import { localStg } from '@/utils/storage';

import { useCacheTabs } from '../tab/tabHooks';

import { resetAuth as resetAuthAction, setToken, setUserInfo } from '../../stores/modules/auth';

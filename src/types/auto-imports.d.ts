...
declare global {
  ...
  const AppLogo: typeof import('../components/AppLogo')['default']
  ...
  const IconIcBaselineAdd: typeof import('~icons/ic/baseline-add.tsx')['default']
  const IconIcBaselineArrowBack: typeof import('~icons/ic/baseline-arrow-back.tsx')['default']
  const IconIcBaselineKeyboardArrowDown: typeof import('~icons/ic/baseline-keyboard-arrow-down.tsx')['default']
  const IconIcBaselineKeyboardArrowLeft: typeof import('~icons/ic/baseline-keyboard-arrow-left.tsx')['default']
  const IconIcBaselineKeyboardArrowRight: typeof import('~icons/ic/baseline-keyboard-arrow-right.tsx')['default']
  const IconIcBaselineKeyboardArrowUp: typeof import('~icons/ic/baseline-keyboard-arrow-up.tsx')['default']
  const IconIcBaselineRadioButtonUnchecked: typeof import('~icons/ic/baseline-radio-button-unchecked.tsx')['default']
  const IconIcBaselineRemove: typeof import('~icons/ic/baseline-remove.tsx')['default']
  const IconIcBaselineVideocam: typeof import('~icons/ic/baseline-videocam.tsx')['default']
  const IconIcRoundAdd: typeof import('~icons/ic/round-add.tsx')['default']
  const IconIcRoundClose: typeof import('~icons/ic/round-close.tsx')['default']
  ...
  const getKeys: typeof import('../utils/common')['getKeys']
